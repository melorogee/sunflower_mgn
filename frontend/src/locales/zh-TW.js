export default {
  ...
  'menu.CreditRating.rating': '信用評級',
  'menu.CreditRating.overviews': '概覽',
  'menu.CreditRating.model': '模型',
  'menu.CreditMarketing': '信用業務營銷',
  'menu.CreditMarketing.marketing': '信用業務營銷活動',
  'menu.CreditMarketing.marketing-effect': '信用业务营销效果',
