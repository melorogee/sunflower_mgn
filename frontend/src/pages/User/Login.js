                            ...
                            <div className={layoutstyles.top}>
                                <div className={layoutstyles.header}>
                                    <Link to="/">
                                        ...
                                        <span className={layoutstyles.title}> 智能客群洞察</span>
                                    </Link>
                                </div>
                            </div>
                            <div className={styles.main}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <UserName name="user_name" placeholder="username" onPressEnter={() => this.loginForm.validateFields(this.handleSubmit)} />
                                    </div>
