                            ...
                            function(a, c, i, k, m) {
                              return a
                                ...
                                : (n.logger.info(
                                  ...
                                  n.logger.info(
                                    'CSS for ' + k.href + ' generated in ' + (new Date() - h) + 'ms'
                                  ),
                                  l--,
                                  0 === l &&
                                    ((j = new Date() - g),
                                    n.logger.info(
                                      'Less has finished. CSS generated in ' + j + 'ms'
                                    ),
                                    d({
                                      startTime: g,
                                      endTime: h,
        ...
        function(a, b, c) {
          b.exports = function(a, b) {
            var c = 4,
              ...
              f = 1;
            (b.logLevel =
              'undefined' != typeof b.logLevel ? b.logLevel : 'development' === b.env ? d : f),
              b.loggers ||
                (b.loggers = [
                  {
                    debug: function(a) {
        ...
        function(a, b, c) {
          ...
          (h = {
            ...
            luminance: function(a) {
              var b =
                (0.2126 * a.rgb[0]) / 255 + (0.7152 * a.rgb[1]) / 255 + (0.0722 * a.rgb[2]) / 255;
        ...
        function(a, b, c) {
          b.exports = function(b) {
            ...
            e.add('data-uri', function(a, e) {
              ...
              if (!q.contents)
                return (
                  g.warn('Skipped data-uri embedding of ' + i + ' because file not found'),
                  f(this, e || a)
                );
              var r = q.contents;
              ...
              for (c = 0; c < b.length; c++)
                if (((g = b[c]), g instanceof d))
                  ...
                  Array.isArray(b[c].value) &&
                    Array.prototype.push.apply(b, Array.prototype.slice.call(b[c].value));
              return 1 == m.length
                ? m[0]
                : ((b = m
                    .map(function(a) {
      ...
      27: [
        function(a, b, c) {
          ...
          g.addMultiple({
            ...
            '%': function(a) {
              for (
                var b = Array.prototype.slice.call(arguments, 1), c = a.value, e = 0;
                e < b.length;
                e++
              )
            ...
            h.add('svg-gradient', function(a) {
              ...
              for (
                ...
                h[k] instanceof e
                  ...
                  : ((l = h[k]), (m = void 0)),
                  (l instanceof d &&
                    (((0 === k || k + 1 === h.length) && void 0 === m) || m instanceof c)) ||
                    b(),
                ...
                switch (j) {
                  ...
                  case 47:
                    ...
                    if (((k = a.charCodeAt(h + 1)), 47 == k))
                      for (
                        h += 2;
                        h < m && ((k = a.charCodeAt(h)), !(k <= 13) || (10 != k && 13 != k));
                        h++
                      );
                    else if (42 == k) {
                      for (
          ...
          b.exports = function() {
            ...
            return (
              ...
              (k.$re = function(b) {
                ...
                var c = b.exec(h);
                return c
                  ? (a(c[0].length), 'string' == typeof c ? c : 1 === c.length ? c[0] : c)
                  : null;
              }),
              (k.$char = function(c) {
          ...
          var d = a('../less-error'),
            ...
            i = function j(a, b, c) {
              ...
              function l(a, b) {
                return o.$char(a)
                  ? a
                  : void i(b || "expected '" + a + "' got '" + o.currentChar() + "'");
              }
              function m(a) {
                var b = c.filename;
                return {
              ...
              return {
                parse: function(g, h, i) {
                  ...
                  var w = function(a) {
                    return (
                      (a = p || a || b.error),
                      a ? (a instanceof d || (a = new d(a, b, c.filename)), h(a)) : h(null, k)
                    );
                  };
                ...
                parsers: (n = {
                  ...
                  entities: {
                    quoted: function() {
                      ...
                      return (
                        ...
                        (a = o.$quoted())
                          ? (o.forget(),
                            new e.Quoted(a.charAt(0), a.substr(1, a.length - 2), d, b, c))
                          : void o.restore()
                      );
                    },
                    keyword: function() {
                    ...
                    arguments: function() {
                      var a,
                        ...
                        g = [];
                      for (o.save(); ; ) {
                        if (((c = n.detachedRuleset() || this.assignment() || n.expression()), !c))
                          break;
                        (b = c),
                      ...
                      return (
                        ...
                        o.$str('url(')
                          ? ((a =
                            ...
                            l(')'),
                            new e.URL(
                              null != a.value || a instanceof e.Variable ? a : new e.Anonymous(a),
                              b,
                              c
                            ))
                    ...
                    javascript: function() {
                      ...
                      return f
                        ? (a = o.$re(/^[^`]*`/))
                          ? (o.forget(),
                            new e.JavaScript(a.substr(0, a.length - 1), Boolean(d), b, c))
                    ...
                    call: function() {
                      ...
                      if ('.' === i || '#' === i) {
                        for (o.save(); ; ) {
                          if (
                            ((a = o.i),
                            (f = o.$re(/^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/)),
                            !f)
                          )
                            break;
                      ...
                      for (o.save(); ; ) {
                        ...
                        if (
                          ...
                          if (o.$char(':')) {
                            if (
                              (m.length > 0 &&
                                (b && i('Cannot mix ; and , as delimiter types'), (c = !0)),
                    ...
                    if (f) {
                      ...
                      if ((a = this.entities.quoted() || this.entities.url()))
                        return (
                          ...
                          o.$char(';') ||
                            ((o.i = d),
                            i('missing semi-colon or unrecognised media features on import')),
                          (b = b && new e.Value(b)),
                  ...
                  plugin: function() {
                    ...
                    if (d) {
                      ...
                      if ((a = this.entities.quoted() || this.entities.url()))
                        return (
                          o.$char(';') || ((o.i = b), i('missing semi-colon on plugin')),
                    ...
                    if ('@' === o.currentChar()) {
                      ...
                      if ((o.save(), (b = o.$re(/^@[a-z-]+/)))) {
                        ...
                        return (
                          ...
                          f || (!n && d && o.$char(';'))
                            ? (o.forget(),
                              new e.Directive(b, d, f, l, c, a.dumpLineNumbers ? m(l) : null, p))
                  ...
                  parenthesisCondition: function() {
                    function a(a) {
                      ...
                      return (
                        o.save(),
                        (b = a.condition()) && o.$char(')') ? (o.forget(), b) : void o.restore()
                      );
                    }
                    var b;
                    return (
                        ...
                        a
                          ...
                          : ((a = this.addition() || this.entity()),
                            a &&
                              (c.push(a),
                              o.peek(/^\/[\/*]/) ||
                                ((b = o.$char('/')), b && c.push(new e.Anonymous(b)))));
                    while (a);
                  ...
                  ruleProperty: function() {
                    ...
                    if (f.length > 1 && a(/^((?:\+_|\+)?)\s*:/)) {
                      for (
                        o.forget(), '' === f[0] && (f.shift(), g.shift()), d = 0;
                        d < f.length;
                        d++
                      )
                        (b = f[d]),
        ...
        function(a, b, c) {
          ...
          (d.prototype.addPlugins = function(a) {
            ...
            (d.prototype.addPreProcessor = function(a, b) {
              ...
              for (
                c = 0;
                c < this.preProcessors.length && !(this.preProcessors[c].priority >= b);
                c++
              );
            ...
            (d.prototype.addPostProcessor = function(a, b) {
              ...
              for (
                c = 0;
                c < this.postProcessors.length && !(this.postProcessors[c].priority >= b);
                c++
              );
          ...
          b.exports = function(a) {
            var b = function(b) {
              (this._css = []),
                ...
                b.sourceMapFilename &&
                  (this._sourceMapFilename = b.sourceMapFilename.replace(/\\/g, '/')),
                (this._outputFilename = b.outputFilename),
                (this.sourceMapURL = b.sourceMapURL),
                b.sourceMapBasepath &&
                  (this._sourceMapBasepath = b.sourceMapBasepath.replace(/\\/g, '/')),
                b.sourceMapRootpath
        ...
        function(a, b, c) {
          ...
          (e.prototype = new d()),
            ...
            (e.prototype.toCSS = function(a) {
              ...
              return (
                this.op &&
                  ((b += this.op), (b += this.value.toCSS ? this.value.toCSS(a) : this.value)),
                '[' + b + ']'
              );
            }),
            (b.exports = e);
          ...
          (h.prototype = new d()),
            ...
            (h.prototype.genCSS = function(a, b) {
              ...
              var c = this.fround(a, this.value),
                d = String(c);
              if (
                (0 !== c && c < 1e-6 && c > -1e-6 && (d = c.toFixed(20).replace(/0+$/, '')),
                a && a.compress)
              ) {
            ...
            (h.prototype.compare = function(a) {
              ...
              if (a instanceof h) {
                ...
                else if (((b = this.unify()), (c = a.unify()), 0 !== b.unit.compare(c.unit)))
                  return;
            ...
            (g.prototype.eval = function(a) {
              ...
              return (
                ...
                this.value.length > 1
                  ...
                  : 1 === this.value.length
                    ? (this.value[0].parens && !this.value[0].parensInOp && (d = !0),
        ...
        function(a, b, c) {
          ...
          (j.prototype = new i()),
            ...
            (j.prototype.eval = function(a) {
              ...
              this.debugInfo &&
                ((this.rules[0].debugInfo = this.debugInfo), (b.debugInfo = this.debugInfo));
              var c = !1;
                ...
                !this.condition.eval(
                  new i.Eval(
                    ...
                    [
                      this.evalParams(
                        b,
                        new i.Eval(b, this.frames ? this.frames.concat(b.frames) : b.frames),
                        a,
                        []
                      ),
                    ]
        ...
        function(a, b, c) {
          ...
          (d.prototype.toCSS = function(a) {
            ...
            (d.prototype.copyVisibilityInfo = function(a) {
              a &&
                ((this.visibilityBlocks = a.visibilityBlocks), (this.nodeVisible = a.nodeVisible));
            }),
            (b.exports = d);
        },
        {},
          ...
          (h.prototype = new e()),
            ...
            (h.prototype.eval = function(a) {
              var b,
                ...
                f = this.variable;
              'string' != typeof e &&
                ((e = 1 === e.length && e[0] instanceof g ? e[0].value : d(a, e)), (f = !1)),
        ...
        function(a, b, c) {
          ...
          (m.prototype = new d()),
            ...
            (m.prototype.matchCondition = function(a, b) {
              ...
              return (
                !!c.evaldCondition && !(c.condition && !c.condition.eval(new i.Eval(b, b.frames)))
              );
            }),
                ...
                for (o = [], p = [[]], h = 0; h < c.elements.length; h++)
                  if (((s = c.elements[h]), '&' !== s.value)) {
                    ...
                    for (v = !0, q = [], k(o, p), m = 0; m < p.length; m++)
                      if (((r = p[m]), 0 === b.length))
                        r.length > 0 &&
                          r[0].elements.push(new g(s.combinator, '', s.index, s.currentFileInfo)),
                          q.push(r);
                      else
                ...
                for (k(o, p), h = 0; h < p.length; h++)
                  (t = p[h].length),
                    t > 0 &&
                      (a.push(p[h]),
                      (u = p[h][t - 1]),
                      (p[h][t - 1] = u.createDerived(u.elements, c.extendList)));
                return v;
              }
              function m(a, b) {
        ...
        function(a, b, c) {
          ...
          (e.prototype = new d()),
            ...
            (e.prototype.eval = function(a) {
              ...
              if (
                (0 === c.indexOf('@@') &&
                  (c = '@' + new e(c.slice(1), this.index, this.currentFileInfo).eval(a).value),
                this.evaluating)
              )
                throw {
                  type: 'Name',
            ...
            visitRuleset: function(a, b) {
              if (!a.root) {
                var c,
                  ...
                  j = i ? i.length : 0;
                for (c = 0; c < j; c++)
                  a.rules[c] instanceof d.Extend && (h.push(i[c]), (a.extendOnEveryPath = !0));
                var k = a.paths;
          ...
          (h.prototype = {
            ...
            checkExtendsForNonMatched: function(a) {
              ...
              a.filter(function(a) {
                ...
                b[a.index + ' ' + c] ||
                  ((b[a.index + ' ' + c] = !0), f.warn("extend '" + c + "' has no matches"));
              });
            },
            ...
            isElementValuesEqual: function(a, b) {
              ...
              if (((a = a.value), (b = b.value), a instanceof d.Selector)) {
                if (!(b instanceof d.Selector) || a.elements.length !== b.elements.length)
                  return !1;
                for (var c = 0; c < a.elements.length; c++) {
                  if (
                    ...
                    return !1;
                  if (!this.isElementValuesEqual(a.elements[c].value, b.elements[c].value))
                    return !1;
                }
                return !0;
              }
        ...
        function(a, b, c) {
          ...
          (g.prototype = {
            ...
            onImported: function(a, b, c, d, e, f) {
              c &&
                (c.filename || ((c.index = a.index), (c.filename = a.currentFileInfo.filename)),
                (this.error = c));
              var g = this,
                h = a.options.inline,
                i = a.options.plugin,
        ...
        function(a, b, c) {
          ...
          f.prototype = {
            containsSilentNonBlockedChild: function(a) {
              ...
              if (null == a) return !1;
              for (var c = 0; c < a.length; c++)
                if (((b = a[c]), b.isSilent && b.isSilent(this._context) && !b.blocksVisibility()))
                  return !0;
              return !1;
            },
            ...
            isVisibleRuleset: function(a) {
              return (
                !!a.firstRoot || (!this.isEmpty(a) && !(!a.root && !this.hasVisibleSelector(a)))
              );
            },
          };
          var g = function(a) {
          ...
          (g.prototype = {
            ...
            visitMedia: function(a, b) {
              ...
              return (
                a.accept(this._visitor), (b.visitDeeper = !1), this.utils.resolveVisibility(a, c)
              );
            },
            visitImport: function(a, b) {
            ...
            visitRuleset: function(a, b) {
              ...
              if ((this.checkValidNodes(a.rules, a.firstRoot), a.root))
                ...
                for (var e = a.rules, f = e ? e.length : 0, g = 0; g < f; )
                  (c = e[g]),
                    c && c.rules ? (d.push(this._visitor.visit(c)), e.splice(g, 1), f--) : g++;
              ...
              if (a) {
                ...
                for (e = a.length - 1; e >= 0; e--)
                  if (((c = a[e]), c instanceof d.Rule))
                    if (f[c.name]) {
                      (b = f[c.name]),
                        b instanceof d.Rule && (b = f[c.name] = [f[c.name].toCSS(this._context)]);
